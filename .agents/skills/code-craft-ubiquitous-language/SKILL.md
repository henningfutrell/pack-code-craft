---
name: code-craft-ubiquitous-language
...
overlay at `.agents/code-craft/code-craft-ubiquitous-language.local.md`. Then these defaults, in
...
| Domain events and commands | yes — via `/code-craft-event-naming` |
