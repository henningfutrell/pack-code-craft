...
Doctrine: `/code-craft-ubiquitous-language`, and `AGENTS.CORE.md` "DDD, applied to a workflow
repo". Entry shape and worked examples:
`.agents/skills/code-craft-ubiquitous-language/references/glossary-format.md`.
