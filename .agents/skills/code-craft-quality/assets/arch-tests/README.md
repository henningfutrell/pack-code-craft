...
encode the architecture and test-boundary rules from `code-craft-quality/SKILL.md` and
`code-craft-tdd/SKILL.md` as machine rules — see `references/enforcement.md` for the
